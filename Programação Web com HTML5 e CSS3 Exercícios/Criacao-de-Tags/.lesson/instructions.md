...
* Crie um header que contenha:
    ...
    * Crie um menu usando a tag `<nav>` com os seguintes items: Cursos e Contato. Os links devem apontar para "#". Ex: `<a href="#"> Sobre </a>`

* Crie uma tag `<main>` que possua um parágrafo com o seguinte texto:
  ```
